...
export default function ServicePage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setFormData({ name: "", phone: "", propertyType: "", location: "", description: "" });
        } catch (error) {
    ...
    return (
        <section className="container mx-auto py-12">
            ...
            {/* Steps Section */}
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mt-12 w-3/5 mx-auto">
                {[
                    { step: "1", title: "List Your Property Details", desc: "Add All The Information Related To Your Property" },
                    { step: "2", title: "One Of Our Agents Will Call You", desc: "We Will Help You Find The Best Buyer" },
                    { step: "3", title: "Meet With Serious Buyers", desc: "Final Step To Sell Your Property" }
                ].map((item, index) => (
                    <div key={index} className="bg-gray-200 p-6 rounded-lg text-center hover:shadow-lg hover:scale-110 duration-700">
            ...
            {/* Contact Form */}
            <div className="mt-16 w-3/5 mx-auto p-8 shadow-lg rounded-lg bg-gray-200">
                <h2 className="text-xl font-semibold text-center mb-6">List Your Property</h2>
